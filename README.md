...
* **Interactive Human Comments & RAG Feedback Loop**: Allows users to attach custom notes/guidelines to any tender. Comments are automatically appended to the tender's semantic embedding text (to improve vector query matching) and supplied in few-shot LLM examples, enabling the AI to learn directly from past human corrections.
